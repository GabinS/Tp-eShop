...
<div class="header">
  ...
  <ol id="menu">
    ...
    <li class="active_menu_item"><a href="/">Connection</a></li>
  </ol>
</div>
<!-- END header -->
<div id="container">
  <div class="one-half">
    ...
    <form action="/home" id="contact_form" method="post">
      <fieldset>
        <label>Login</label>
      ...
      <fieldset>
        ...
        <input type="password" name="email" id="myemail" value="" class="text requiredField email">
      </fieldset>
      
      <div style="clear:both; height: 40px"></div>
      
      <fieldset>
        <input name="Mysubmitted" id="Mysubmitted" value="Connection" class="button white" type="submit">
      </fieldset>
    </form>
